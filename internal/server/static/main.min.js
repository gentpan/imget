!function(){function t(t){var e=t.getAttribute("data-src");e&&(t.src=e,t.removeAttribute("data-src"),t.classList.remove("lazyload"))}function e(){var e=document.querySelectorAll("img.lazyload[data-src]");if(!("IntersectionObserver"in window)){e.forEach(t);return}var n=new IntersectionObserver(function(e){e.forEach(function(e){e.isIntersecting&&(t(e.target),n.unobserve(e.target))})},{rootMargin:"300px 0px"});e.forEach(function(t){n.observe(t)})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",e):e()}();
;
/**
 ...
 */
 ...
 ;
    (function () {
      var primarySiteBaseUrl = (document.body && document.body.dataset && document.body.dataset.siteBaseUrl) || window.location.origin;
      ...
      var keywordInput = document.getElementById('tester-keyword');
      ...
      [widthInput, heightInput, typeInput, formatInput, modeInput, rInput, slotInput, keywordInput].forEach(function (element) {
        if (!element) return;
    ...
    var __imgetCheckSvg = '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.6" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>';
    document.querySelectorAll('.copy-btn').forEach(function (button) {
      ...
      button.addEventListener('click', async function () {
        ...
        try {
          ...
          button.innerHTML = __imgetCheckSvg;
